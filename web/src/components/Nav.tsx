...
const menuItems = [
    ...
    {
        element: (
            <Link activeClassName="active" href="/awareness/">
                awareness
            </Link>
        )
    },
    ...
    {
        element: <a href="https://vindelicum.eu/impressum/">legal</a>
    },
    {
        element: <a href="https://vindelicum.eu/datenschutz/">privacy</a>
    }
];
